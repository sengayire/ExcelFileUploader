...
const debug = require('debug')('excel-file-uploader:server');
...
function onListening() {
  ...
  if (process.env.APP_URL_BACKEND) {
    return process.stdout.write(`Server is running at: ${process.env.APP_URL_BACKEND}\n`);
  }
  return process.stdout.write(`Server is running on http://localhost:${addr?.port}/docs\n`);
}
